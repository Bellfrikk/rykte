...
export function sideSetter(nyNr:number){ side = nyNr; console.log('min side er satt til '+ side); }

status('velgGruppe');

export function status(nyStatus:'velgGruppe' | 'velgOrd'| 'lagGruppe'|'venteTilStart'|'tegneFane'|'gjetteFane'|'visFane'){
